...
varKeep <- c("PCTWHITE","PCTBLACK","PCTHISPAN","MEDAGE",
             ...
             "POPDEN","PCTHUVAC","MEDVALHOME","PRE1960","POST2000")
xVars <- tractShp@data
xVars <- xVars[varKeep]
summary(xVars)
...
plot(Dallas_lakesShp, col="skyblue", border="skyblue",add=T)
plot(Dallas_hwyShp, col="cornsilk2", lwd=4, add=T)
```
...
plotBoxesByFactor(xVars[,8:13], neighClus, ncol=2, zTrans=T, varwidth=F)
```
